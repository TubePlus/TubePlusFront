...
const fetchComments = async (postId: string) => {
  const res = await fetch(`https://652c497bd0d1df5273ef56a5.mockapi.io/api/v1/post/${postId}/comments`);
  if (!res.ok) {
    throw new Error('Network response was not ok');
  }
  return res.json();
    ...
    <Card style={postStyle}> 
      ...
      <div className='flex flex-nowrap pt-5 pl-5 pr-5 border-t-5'>
        ...
        <div className='pl-7 pb-5'>
          <Button onClick={() => setCommentView(!isCommentView)} color='primary' variant='light' size='sm'>
